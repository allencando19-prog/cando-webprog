      ...
      <html lang="en">
        <head>
          ...
          <style>
            ...
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .print-accent {
              height: 4px;
              background: linear-gradient(90deg, #1a3a6b, #d4a017, #f0c040);
            }
        ...
        <body>
          <div class="print-header">
            <div>
              <div class="print-header-title">Reports Summary</div>
              <div class="print-header-sub">Analytics overview for generated reports, category breakdown, and completion performance.</div>
            </div>
            <div>
              <div class="print-header-date">Prepared on ${exportedAt}</div>
              <span class="print-badge">Confidential</span>
            </div>
          </div>
          ...
          <div class="print-body">
            ...
            <div class="print-footer">
              <span>Cando Reports</span>
              <span>Generated automatically · ${exportedAt}</span>
            </div>
          </div>
        </body>
      </html>
